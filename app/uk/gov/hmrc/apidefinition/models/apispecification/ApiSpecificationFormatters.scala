...
object ApiSpecificationFormatters {
  ...
  implicit val securitySchemeJF: Format[SecurityScheme] = Json.format[SecurityScheme]

  implicit val groupJF: Format[Group] = Json.format[Group]
  ...
  implicit val hmrcMethodJFL: Format[Method]    = Json.format[Method]
  implicit val hmrcResourceJF: Format[Resource] = Json.format[Resource]

  implicit val documentationItemJF: Format[DocumentationItem] = Json.format[DocumentationItem]
  implicit val hmrcResourceGroupJF: Format[ResourceGroup]     = Json.format[ResourceGroup]

  implicit val apiSpecificationJF: Format[ApiSpecification] = Json.format[ApiSpecification]
